package by.epam.unit_6.task_2;

/*
unit_6.task_2: Блокнот. Разработать консольное приложение, работающее с Заметками в Блокноте.
...
/*
1. notepad должен быть наверное singleton (это логично если у нас есть только один блокнот с многими заметками)
2. topic и message - под большим вопросом насчет отдельных классов для них
 */
